...
public:
	...
	UPROPERTY(EditAnywhere, Category="TextureReference")
	...
	UPROPERTY(EditAnywhere, Category="TextureReference", meta = (Bitmask, BitmaskEnum = "/Script/TextureSetsCommon.ETextureSetSourceTextureChannelMask"))
	int32 ChannelMask;
